...
int main(int argc, char **argv)
{
	...
	// link shaders  -- (Don't need to understand this until next Session)
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform4f(vertexColorLocation, 0.016f, 0.118f, 0.259f, 0.0f);	//Nittany Navy
		glDrawArrays(GL_TRIANGLES, 0, 3);
		glUniform4f(vertexColorLocation, 1.0f, 1.0f, 1.0f, 0.0f);	//White Out
